...
$(document).ready(function () {
  ...
  var quoteElements = function quoteElements() {
    var quoteString = "";
    var authorString = "";
    var tweetString = "";
    var tumblrString = "";
    ...
    var tumblr = /*#__PURE__*/React.createElement("a", {
      id: "tumblr-quote",
      class: "btn bg-color",
      href: tumblrString,
      target: "_blank"
    ...
    ReactDOM.render(author, document.getElementById('author-text'));
    ReactDOM.render(tweet, document.getElementById('tweet-quote-container'));
    ReactDOM.render(tumblr, document.getElementById('tumblr-quote-container'));
  };

  quoteElements();
  var newQuote = /*#__PURE__*/React.createElement("button", {
    id: "new-quote",
    type: "button",
    class: "btn rounded bg-color",
    onClick: quoteElements
  }, "New Quote");
  ReactDOM.render(newQuote, document.getElementById('button-div'));
  /*Assign random color to variable on load*/

  var color = "";

  var generateColor = function generateColor() {
    var coloursArr = ["#A64253", "#EC4E20", "#861657", "#BBDBB4", "#F6AE2D", "#33658A", "#86BBD8", "#F991CC", "#23CE6B", "#FB9F89", "#21A179", "#119DA4", "#13505B", "#A3CEF1", "#8338EC", "#EE964B", "#444554", "#5B7553", "#D84A05"];
    var index = Math.floor(Math.random() * coloursArr.length);
